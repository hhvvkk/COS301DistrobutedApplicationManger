...
int main(){
	...
	Master correct(1,"123.456.789.255","online",0);
	...
	Slave slaveBoy(1,"123.555.789.255","online",1);
	...
	cout<<endl<<"Adding four Build objects to the Slave object and calling Slave::printBuilds()"<<endl;
